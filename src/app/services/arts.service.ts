...
export class ArtsService {
  ...
  addRandomArts(): Art[]{
    ...
    this.artsList.push(new Art(4, "Van Gogh", "fdwfwff", 35,"../assets/nachtwacht .jpg",false));
    this.artsList.push(new Art(5, "Van jem", "fdwfwff", 50,"../assets/nachtwacht .jpg",true));
    this.artsList.push(new Art(6, "Van blbl", "fdwfwff", 60,"../assets/nachtwacht .jpg",false));
